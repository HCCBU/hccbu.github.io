...
We have some exciting PhD opprtunities, funded from our [UKRI Centre for Doctoral Training in Artificial Intelligence, Machine Learning & Advanced Computing](http://cdt-aimlac.org/cdt-research.html){:target="\_blank"}.

- Project title: _Edge-based object recognition for immersive analytics in Web-based XR_
- Supervisors:[Dr Panagiotis D. Ritsos](https://sopanpatil.weebly.com/) and [Prof Jonathan C. Roberts](https://www.bangor.ac.uk/computer-science-and-electronic-engineering/staff/jonathan-roberts/en)
- Department/Institution: [School of Computer Science and Electronic Engineering, Bangor University](https://www.bangor.ac.uk/computer-science-and-electronic-engineering/){:target="\_blank"}
